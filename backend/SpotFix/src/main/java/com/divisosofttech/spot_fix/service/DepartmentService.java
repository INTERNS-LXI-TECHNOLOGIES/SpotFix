...
/**
 * Service Interface for managing {@link com.divisosofttech.spot_fix.domain.Department}.
 */
public interface DepartmentService {
     ...
     */
    Flux<DepartmentDTO> findByCriteria(DepartmentCriteria criteria, Pageable pageable);
