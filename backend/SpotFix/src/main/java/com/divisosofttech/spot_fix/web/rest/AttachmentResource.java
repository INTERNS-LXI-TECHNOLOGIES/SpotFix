...
/**
 * REST controller for managing {@link com.divisosofttech.spot_fix.domain.Attachment}.
 */
@RestController
...
public class AttachmentResource {
     ...
     */
    @GetMapping("/{id}")
    public Mono<ResponseEntity<AttachmentDTO>> getAttachment(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public Mono<ResponseEntity<Void>> deleteAttachment(@PathVariable("id") Long id) {
