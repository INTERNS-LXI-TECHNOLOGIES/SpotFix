...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.divisosofttech.spot_fix.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.divisosofttech.spot_fix.security.DomainUserDetailsService", "createSpringSecurityUser");
