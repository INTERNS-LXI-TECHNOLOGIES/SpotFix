...
import com.diviso.spot_fix.service.TicketStatusHistoryQueryService;
...
/**
 * REST controller for managing {@link com.diviso.spot_fix.domain.TicketStatusHistory}.
 */
@RestController
...
public class TicketStatusHistoryResource {
    ...
    private final TicketStatusHistoryQueryService ticketStatusHistoryQueryService;
    ...
    public TicketStatusHistoryResource(
        ...
        TicketStatusHistoryQueryService ticketStatusHistoryQueryService
    ) {
        ...
        this.ticketStatusHistoryQueryService = ticketStatusHistoryQueryService;
    }
     ...
     */
    @PostMapping("")
    public ResponseEntity<TicketStatusHistoryDTO> createTicketStatusHistory(
        ...
        ticketStatusHistoryDTO = ticketStatusHistoryService.save(ticketStatusHistoryDTO);
        return ResponseEntity.created(new URI("/api/ticket-status-histories/" + ticketStatusHistoryDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, ticketStatusHistoryDTO.getId().toString()))
            .body(ticketStatusHistoryDTO);
    }
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<TicketStatusHistoryDTO> updateTicketStatusHistory(
        ...
        ticketStatusHistoryDTO = ticketStatusHistoryService.update(ticketStatusHistoryDTO);
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, ticketStatusHistoryDTO.getId().toString()))
            .body(ticketStatusHistoryDTO);
    }
    ...
    public ResponseEntity<TicketStatusHistoryDTO> partialUpdateTicketStatusHistory(
        @PathVariable(value = "id", required = false) final Long id,
        ...
        Optional<TicketStatusHistoryDTO> result = ticketStatusHistoryService.partialUpdate(ticketStatusHistoryDTO);

        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, ticketStatusHistoryDTO.getId().toString())
        );
    }
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<TicketStatusHistoryDTO>> getAllTicketStatusHistories(
        TicketStatusHistoryCriteria criteria,
        @org.springdoc.core.annotations.ParameterObject Pageable pageable
    ) {
        LOG.debug("REST request to get TicketStatusHistories by criteria: {}", criteria);

        Page<TicketStatusHistoryDTO> page = ticketStatusHistoryQueryService.findByCriteria(criteria, pageable);
     ...
     */
    @GetMapping("/count")
    public ResponseEntity<Long> countTicketStatusHistories(TicketStatusHistoryCriteria criteria) {
        LOG.debug("REST request to count TicketStatusHistories by criteria: {}", criteria);
        return ResponseEntity.ok().body(ticketStatusHistoryQueryService.countByCriteria(criteria));
    }
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<TicketStatusHistoryDTO> getTicketStatusHistory(@PathVariable("id") Long id) {
        LOG.debug("REST request to get TicketStatusHistory : {}", id);
        Optional<TicketStatusHistoryDTO> ticketStatusHistoryDTO = ticketStatusHistoryService.findOne(id);
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteTicketStatusHistory(@PathVariable("id") Long id) {
        LOG.debug("REST request to delete TicketStatusHistory : {}", id);
        ticketStatusHistoryService.delete(id);
