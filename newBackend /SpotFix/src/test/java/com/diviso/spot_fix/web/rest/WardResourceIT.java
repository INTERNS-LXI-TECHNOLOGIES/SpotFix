...
import static com.diviso.spot_fix.domain.WardAsserts.*;
...
import com.diviso.spot_fix.service.mapper.WardMapper;
...
class WardResourceIT {
    ...
    @Test
    @Transactional
    void getAllWardsByMunicipalityIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedWard = wardRepository.saveAndFlush(ward);
    ...
    @Test
    @Transactional
    void getAllWardsByMunicipalityIsInShouldWork() throws Exception {
        // Initialize the database
        insertedWard = wardRepository.saveAndFlush(ward);
    ...
    @Test
    @Transactional
    void getAllWardsByMunicipalityIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedWard = wardRepository.saveAndFlush(ward);
    ...
    @Test
    @Transactional
    void getAllWardsByMunicipalityContainsSomething() throws Exception {
        // Initialize the database
        insertedWard = wardRepository.saveAndFlush(ward);
    ...
    @Test
    @Transactional
    void getAllWardsByMunicipalityNotContainsSomething() throws Exception {
        // Initialize the database
        insertedWard = wardRepository.saveAndFlush(ward);
